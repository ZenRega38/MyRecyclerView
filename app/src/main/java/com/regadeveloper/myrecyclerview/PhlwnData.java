...
public class PhlwnData {
    private static String[] phlwnName = {
            "Ahmad Dahlan",
            "Ahmad Yani",
            "Sutomo",
            "Gatot Soebroto",
    ...
    private static String[] phlwnDesc = {
    ...
    static ArrayList<Phlwn> getListData() {
        ArrayList<Phlwn> list = new ArrayList<>();
        for (int position = 0; position < phlwnName.length; position++) {
            Phlwn phlwn = new Phlwn();
            phlwn.setPhlwn(phlwnName[position]);
            phlwn.setDesc(phlwnDesc[position]);
            phlwn.setPhoto(phlwnImg[position]);
            list.add(phlwn);
        }
        return list;
    }
